import{c as e,i as t,n,r,s as i}from"./trainingDiagnostics-C36u2R2c.js";var a=null,o=null,s=null,c=null,l=!1;function u(){if(document.getElementById(`training-dashboard-styles`))return;let e=document.createElement(`style`);e.id=`training-dashboard-styles`,e.textContent=`
    .training-dashboard {
  ...
  `,document.head.appendChild(e)}var d={Reward:`#5F9EA0`,"Reward MA":`#5F9EA0`,Steps:`#6F7FA8`,"Steps MA":`#8C97B6`,"Actor Loss":`#D2A24C`,"Critic Loss":`#6F7FA8`,"Actor Delta":`#5F9EA0`,"Critic Delta":`#6E8B74`,"Ratio Mean":`#5F9EA0`,"Ratio Min":`#A0AFCA`,"Ratio Max":`#C75B5B`,Entropy:`#A66DDA`,"Adv Mean":`#6E8B74`,"Adv Std":`#D2A24C`,"State Nonzero":`#8A9591`,"Legal Actions":`#6E8B74`,"Legal Rate":`#5F9EA0`,"Invalid/Valid":`#C75B5B`,"Repeat Move Rate":`#C75B5B`,"Repeat State Rate":`#D28D4C`,"Attack Move Rate":`#6E8B74`,"Win Episodes":`#6E8B74`,"Loss Episodes":`#C75B5B`,"Truncated Episodes":`#A0AFCA`,"Q Delta":`#C75B5B`,Epsilon:`#C9A34A`,"Max Q":`#5F9EA0`,"Visited States":`#6F7FA8`};function f(e){return Object.entries(d).find(([t])=>e.startsWith(t))?.[1]??`#c7ced0`}function p(e){return e.map(e=>{let t=f(e.name),n=e.name.includes(`MA`);return{...e,symbol:`none`,showSymbol:!1,lineStyle:{width:n?3:2,type:n?`dashed`:`solid`,color:t},itemStyle:{color:t},areaStyle:e.name===`Reward`||e.name===`Reward MA`?{color:`${t}22`}:void 0,emphasis:{focus:`series`}}})}function m(){let e=document.getElementById(`graph-container`);if(!e)return null;u(),l||=(e.innerHTML=`
  ...
  `).join(``)}function _(e,t=20,n=5){let r=e.slice(-t),i=new Map,a=0;for(let e of r)for(let t of e.actionCounts??[]){let e=i.get(t.actionId)??{actionId:t.actionId,count:0,label:t.label??`action:${t.actionId}`};e.count+=t.count??0,i.set(t.actionId,e),a+=t.count??0}return Array.from(i.values()).sort((e,t)=>t.count-e.count||e.actionId-t.actionId).slice(0,n).map(e=>({...e,rate:a>0?e.count/a:0}))}function v(e,t){let n=document.getElementById(`action-frequency-summary`);if(!n)return;let r=_(e,t.movingAverageWindow,5);if(r.length===0){n.innerHTML=`<p class="training-dashboard__empty">暂无动作频率数据。</p>`;return}n.innerHTML=`
  ...
  `}function y(e,t=12){let n={win:e.filter(e=>e.outcome===`win`).map(e=>e.reward),loss:e.filter(e=>e.outcome===`loss`).map(e=>e.reward),truncated:e.filter(e=>e.outcome===`truncated`).map(e=>e.reward)},r=Object.values(n).flat();if(r.length===0)return null;let i=Math.min(...r),a=Math.max(...r);i===a&&(i-=.5,a+=.5);let o=(a-i)/t,s=Array(t).fill(null).map((e,n)=>({start:i+o*n,end:n===t-1?a:i+o*(n+1),win:0,loss:0,truncated:0})),c=e=>{let n=Math.floor((e-i)/o);return Math.max(0,Math.min(t-1,n))};for(let[e,t]of Object.entries(n))for(let n of t)s[c(n)][e]+=1;return{labels:s.map(e=>`${e.start.toFixed(2)} to ${e.end.toFixed(2)}`),winData:s.map(e=>e.win),lossData:s.map(e=>e.loss),truncatedData:s.map(e=>e.truncated)}}function b(e){let t=y(e);if(!t)return{title:{text:`Reward Distribution`,textStyle:{fontSize:16,fontWeight:700,color:`#2C3432`,fontFamily:`"STSong", "Songti SC", "Noto Serif SC", serif`}},graphic:{type:`text`,left:`center`,top:`middle`,style:{text:`No outcome reward data yet`,fill:`#68716D`,fontSize:13}}};let n=p([{name:`Win Episodes`,type:`bar`,stack:`reward-distribution`,data:t.winData},{name:`Loss Episodes`,type:`bar`,stack:`reward-distribution`,data:t.lossData},{name:`Truncated Episodes`,type:`bar`,stack:`reward-distribution`,data:t.truncatedData}]).map(e=>({...e,barMaxWidth:24,areaStyle:void 0}));return{backgroundColor:`#ffffff`,color:Object.values(d),animationDuration:300,tooltip:{trigger:`axis`,axisPointer:{type:`shadow`},backgroundColor:`rgba(255, 255, 255, 0.96)`,borderColor:`rgba(60, 70, 60, 0.08)`,borderWidth:1,textStyle:{color:`#2C3432`,fontSize:13}},legend:{top:8,textStyle:{color:`#68716D`,fontSize:12}},grid:{left:`7%`,right:`4%`,bottom:`16%`,top:`20%`,containLabel:!0},xAxis:{type:`category`,data:t.labels,axisLabel:{color:`#68716D`,fontSize:11,rotate:18},axisLine:{lineStyle:{color:`#D6DBD8`}}},yAxis:{type:`value`,name:`Episodes`,axisLabel:{color:`#68716D`,fontSize:12},axisLine:{show:!0,lineStyle:{color:`#D6DBD8`}},splitLine:{lineStyle:{color:`#E8EBE8`}},nameTextStyle:{color:`#68716D`,fontSize:12}},series:n}}function x(e,t){let n=i(e,`reward`,t.movingAverageWindow),r=i(e,`steps`,t.movingAverageWindow);return[{name:`Reward`,type:`line`,smooth:!0,yAxisIndex:0,data:e.map(e=>e.reward)},{name:`Reward MA(${t.movingAverageWindow})`,type:`line`,smooth:!0,yAxisIndex:0,data:n},{name:`Steps`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.steps)},{name:`Steps MA(${t.movingAverageWindow})`,type:`line`,smooth:!0,yAxisIndex:1,data:r}]}function S(e,t){let n=[];return t.mode===`ppo`?(r(e,`actorLoss`)&&n.push({name:`Actor Loss`,type:`line`,smooth:!0,yAxisIndex:0,data:e.map(e=>e.actorLoss)}),r(e,`criticLoss`)&&n.push({name:`Critic Loss`,type:`line`,smooth:!0,yAxisIndex:0,data:e.map(e=>e.criticLoss)}),r(e,`actorParamDelta`)&&n.push({name:`Actor Delta`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.actorParamDelta)}),r(e,`criticParamDelta`)&&n.push({name:`Critic Delta`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.criticParamDelta)})):t.mode===`qlearning`&&(r(e,`qDelta`)&&n.push({name:`Q Delta`,type:`line`,smooth:!0,yAxisIndex:0,data:e.map(e=>e.qDelta)}),r(e,`maxQ`)&&n.push({name:`Max Q`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.maxQ)})),n}function C(e,t){let n=[];return r(e,`success`)&&n.push({name:`Success Rate`,type:`line`,smooth:!0,yAxisIndex:0,data:e.map(e=>e.success===null||e.success===void 0?null:Number(e.success))}),r(e,`win`)&&n.push({name:`Win Rate`,type:`line`,smooth:!0,yAxisIndex:0,data:e.map(e=>e.win===null||e.win===void 0?null:Number(e.win))}),t.mode===`ppo`?(r(e,`legalRate`)&&n.push({name:`Legal Rate`,type:`line`,smooth:!0,yAxisIndex:0,data:e.map(e=>e.legalRate)}),r(e,`ratioMean`)&&n.push({name:`Ratio Mean`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.ratioMean)}),r(e,`ratioMin`)&&n.push({name:`Ratio Min`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.ratioMin)}),r(e,`ratioMax`)&&n.push({name:`Ratio Max`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.ratioMax)}),r(e,`entropy`)&&n.push({name:`Entropy`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.entropy)}),r(e,`advantageMean`)&&n.push({name:`Adv Mean`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.advantageMean)}),r(e,`advantageStd`)&&n.push({name:`Adv Std`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.advantageStd)}),r(e,`stateNonzeroCount`)&&n.push({name:`State Nonzero`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.stateNonzeroCount)}),r(e,`legalActions`)&&n.push({name:`Legal Actions`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.legalActions)}),r(e,`invalidPerValid`)&&n.push({name:`Invalid/Valid`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.invalidPerValid)}),r(e,`repeatRate`)&&n.push({name:`Repeat State Rate`,type:`line`,smooth:!0,yAxisIndex:0,data:e.map(e=>e.repeatRate)}),r(e,`repeatMoveRate`)&&n.push({name:`Repeat Move Rate`,type:`line`,smooth:!0,yAxisIndex:0,data:e.map(e=>e.repeatMoveRate)}),r(e,`attackMovesRate`)&&n.push({name:`Attack Move Rate`,type:`line`,smooth:!0,yAxisIndex:0,data:e.map(e=>e.attackMovesRate)})):t.mode===`qlearning`&&(r(e,`epsilon`)&&n.push({name:`Epsilon`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.epsilon)}),r(e,`visitedStates`)&&n.push({name:`Visited States`,type:`line`,smooth:!0,yAxisIndex:1,data:e.map(e=>e.visitedStates)})),n}function w(e,t,n){let r={},i=e=>n===`reward`?e===`Reward`||e.startsWith(`Reward MA`)||e===`Steps`||e.startsWith(`Steps MA`):n===`loss`?t===`ppo`?e===`Actor Loss`||e===`Critic Loss`||e===`Actor Delta`||e===`Critic Delta`:e===`Q Delta`||e===`Max Q`:n===`diagnostics`?t===`ppo`?e===`Ratio Mean`||e===`Legal Rate`||e===`Entropy`||e===`Repeat Move Rate`||e===`State Nonzero`||e===`Invalid/Valid`:e===`Success Rate`||e===`Win Rate`||e===`Epsilon`||e===`Visited States`:!1;for(let t of e)r[t.name]=i(t.name);return r}function T(e,t,n,r,i,a){return{backgroundColor:`#ffffff`,color:Object.values(d),animationDuration:300,title:{text:e,textStyle:{fontSize:18,fontWeight:700,color:`#2C3432`,fontFamily:`"STSong", "Songti SC", "Noto Serif SC", serif`}},tooltip:{trigger:`axis`,backgroundColor:`rgba(255, 255, 255, 0.96)`,borderColor:`rgba(60, 70, 60, 0.08)`,borderWidth:1,textStyle:{color:`#2C3432`,fontSize:14},extraCssText:`box-shadow: 0 8px 24px rgba(0,0,0,0.08); border-radius: 14px;`},legend:{type:`scroll`,top:26,itemGap:18,itemWidth:14,itemHeight:10,selected:w(r,i,a),textStyle:{color:`#68716D`,fontSize:13},pageTextStyle:{color:`#68716D`,fontSize:12},pageIconColor:`#5F9EA0`},grid:{left:`5%`,right:`5%`,bottom:`12%`,top:`26%`,containLabel:!0},xAxis:{type:`category`,name:`Episode`,data:t,axisLine:{lineStyle:{color:`#D6DBD8`}},axisLabel:{color:`#68716D`,fontSize:12},splitLine:{show:!1},nameTextStyle:{color:`#68716D`,fontSize:12}},yAxis:n.map((e,t)=>({type:`value`,name:e,position:t===0?`left`:`right`,axisLine:{show:!0,lineStyle:{color:`#D6DBD8`}},axisLabel:{color:`#68716D`,fontSize:12},splitLine:{lineStyle:{color:`#E8EBE8`}},nameTextStyle:{color:`#68716D`,fontSize:12}})),series:p(r)}}function E(e,t={}){if(!e||e.length===0||!m())return;let n={title:t.title??`RL Training Diagnostics`,subtitle:t.subtitle??`Use the dashboard to inspect reward trends, stability, and failure modes.`,mode:t.mode??(r(e,`qDelta`)?`qlearning`:`ppo`),movingAverageWindow:t.movingAverageWindow??20},i=e.map(e=>e.episode);document.getElementById(`training-dashboard-title`).textContent=n.title,document.getElementById(`training-dashboard-subtitle`).textContent=n.subtitle,document.getElementById(`reward-panel-title`).textContent=`Reward`,document.getElementById(`loss-panel-title`).textContent=n.mode===`ppo`?`Loss`:`Learning Signals`,document.getElementById(`diagnostics-panel-title`).textContent=`Diagnostics`,document.getElementById(`action-frequency-panel-title`).textContent=`Top 5 Actions Frequency (Last ${n.movingAverageWindow})`,document.getElementById(`distribution-panel-title`).textContent=`Win vs Loss Reward Distribution`,g(e,n),v(e,n),a?.setOption(T(`Reward`,i,[`Reward`,`Steps`],x(e,n),n.mode,`reward`),!0),o?.setOption(T(n.mode===`ppo`?`Loss`:`Learning Signals`,i,n.mode===`ppo`?[`Loss`,`Delta`]:[`Value`,`Value`],S(e,n),n.mode,`loss`),!0),s?.setOption(T(`Diagnostics`,i,n.mode===`ppo`?[`Rate`,`Diagnostics`]:[`Rate`,`Exploration`],C(e,n),n.mode,`diagnostics`),!0),c?.setOption(b(e),!0)}export{E as drawlineGraph};